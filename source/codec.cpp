...
void draw_dialogue(char* tab)
{
   ...
   char ligne4[31];
        ...
        GRRLIB_PrintfTTF(75, 280, myFont , ligne1, 28 , CLR_WHITE);
        GRRLIB_PrintfTTF(75, 310, myFont , ligne2, 28 , CLR_WHITE);
        GRRLIB_PrintfTTF(75, 340, myFont , ligne3, 28 , CLR_WHITE);
        GRRLIB_PrintfTTF(75, 370, myFont , ligne4, 28 , CLR_WHITE);
